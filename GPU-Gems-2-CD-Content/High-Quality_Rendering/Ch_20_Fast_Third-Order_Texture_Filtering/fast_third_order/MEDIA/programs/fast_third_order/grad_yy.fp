...
!!ARBfp1.0
	...
	ALIAS	const_e_xp = const_e_z;
	ALIAS	const_e_yp = const_e_x;
	ALIAS	const_e_zp = const_e_y;
	TEMP	coord_ow;
	MAD		coord_ow, filter_srcscale, coord_src, -const_0512.y;
	TEMP	tex_ow_xp;
	TEMP	tex_ow_yp;
	TEX		tex_ow_xp, coord_ow.z, texture[ 2 ], 1D;
	TEX		tex_ow_yp, coord_ow.x, texture[ 2 ], 1D;
	MUL		tex_ow_xp.xy, tex_ow_xp, filter_srcofs.z;
	MUL		tex_ow_yp.xy, tex_ow_yp, filter_srcofs.x;
	TEMP	coord_src000;
	TEMP	coord_src100;
	TEMP	coord_src010;
	TEMP	coord_src110;
