...
!!ARBfp1.0
	...
	TEX		tex_ow_y, coord_ow.y, texture[ 2 ], 1D;
	TEMP	tex_ow_z;
	TEX		tex_ow_z, coord_ow.z, texture[ 3 ], 1D;
	...
	TEMP	tex_src1;
	TEX		tex_src1.r, coord_src001, texture[ 1 ], 3D;
	TEX		tex_src1.g, coord_src101, texture[ 1 ], 3D;
	TEX		tex_src1.b, coord_src011, texture[ 1 ], 3D;
	TEX		tex_src1.a, coord_src111, texture[ 1 ], 3D;
	ALIAS	tex_ow_xp = tex_ow_x;
	ALIAS	tex_ow_yp = tex_ow_y;
	ALIAS	tex_ow_zp = tex_ow_z;
