...
typedef GLvoid         (APIENTRY *PFNGLDETACHOBJECTGL2PROC)(GLhandle containerObj,
                                                            GLhandle attachedObj);
typedef GLvoid         (APIENTRY *PFNGLOBJECTPARAMETERFGL2PROC)(GLhandle obj,
                                                                GLenum pname,
                                                                GLfloat param);
typedef GLvoid         (APIENTRY *PFNGLOBJECTPARAMETERIGL2PROC)(GLhandle obj,
                                                                GLenum pname,
                                                                GLint param);
typedef GLvoid         (APIENTRY *PFNGLGETOBJECTPARAMETERFVGL2PROC)(GLhandle obj,
                                                                    GLenum pname,
                                                                    GLfloat *params);
typedef GLvoid         (APIENTRY *PFNGLGETOBJECTPARAMETERIVGL2PROC)(GLhandle obj,
                                                                    GLenum pname,
                                                                    GLint *params);
typedef GLhandle       (APIENTRY *PFNGLCREATESHADEROBJECTGL2PROC)(GLenum shaderType);
typedef GLvoid         (APIENTRY *PFNGLLOADSHADERGL2PROC)(GLhandle shaderObj,
                                                          GLuint nseg,
                                                          const GLchar **seg,
                                                          const GLint *length);
typedef GLvoid         (APIENTRY *PFNGLAPPENDSHADERGL2PROC)(GLhandle shaderObj,
                                                            const GLchar *seg,
                                                            GLint length);
typedef GLboolean      (APIENTRY *PFNGLCOMPILESHADERGL2PROC)(GLhandle shaderObj);
typedef const GLchar * (APIENTRY *PFNGLGETINFOLOGGL2PROC)(GLhandle obj,
                                                          GLint *length);
typedef const GLchar * (APIENTRY *PFNGLGETSHADERSTRINGGL2PROC)(GLhandle shaderObj,
                                                               GLuint *length);
typedef GLhandle       (APIENTRY *PFNGLCREATEPROGRAMOBJECTGL2PROC)(GLvoid);
typedef GLboolean      (APIENTRY *PFNGLATTACHSHADEROBJECTGL2PROC)(GLhandle programObj,
                                                                  GLhandle shaderObj);
...
typedef GLvoid         (APIENTRY *PFNGLLOADUNIFORMMATRIXARRAY4FVGL2PROC)(GLint location,
                                                                         ...
                                                                         GLuint count,
                                                                         GLfloat *f);
typedef GLint          (APIENTRY *PFNGLGETUNIFORMLOCATIONGL2PROC)(GLhandle programObj,
                                                                  const GLchar *name,
                                                                  GLint length);
typedef GLvoid         (APIENTRY *PFNGLGETUNIFORMFVGL2PROC)(GLhandle programObj,
                                                            GLint location,
                                                            GLfloat *params);
typedef GLvoid         (APIENTRY *PFNGLGETUNIFORMIVGL2PROC)(GLhandle programObj,
                                                            GLint location,
                                                            GLint *params);
...
typedef GLvoid    (APIENTRY *PFNGLBINDATTRIBUTELOCATIONGL2PROC)(GLhandle programObj,
                                                                GLuint index,
                                                                const GLchar *name,
                                                                GLint length);
typedef GLboolean (APIENTRY *PFNGLGETACTIVEATTRIBUTESGL2PROC)(GLhandle programObj,
                                                              GLint *count,
                                                              const GLchar **atributes,
                                                              GLint **length);
