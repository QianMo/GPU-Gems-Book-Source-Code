...
PHG_FLOAT4 vLightDiffuse;
PHG_FLOAT4 vLightSpecular;
                              ...
                              PHG_FLOAT4 vLight    : TEXCOORD5 ) : COLOR
{
	...
	PHG_FLOAT rim = 1.0 - dot( vN, normalize( vEye.xyz ) );
	rim = rim * rim;
	
	// Finalize

#if !GREYSCALE
	return clamp( ( vDiffuse + vSpecular ) * vLightDirection.w + rim * 0.35, 0.0, 1.0 );
#else
	return dot( clamp( ( vDiffuse + vSpecular ) * vLightDirection.w + rim * 0.35, 0.0, 1.0 ), vGreyScale );
#endif
