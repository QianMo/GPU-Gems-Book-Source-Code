...
PHG_FLOAT4 BlinnPixelShader ( PHG_FLOAT2 vTexCoord   : TEXCOORD0,
			      ...
			      PHG_FLOAT3 vBinormal   : TEXCOORD2,
			      PHG_FLOAT3 vNormal     : TEXCOORD3,
			      PHG_FLOAT4 vLight[3]   : TEXCOORD4 ) : COLOR
{
...
#else
	PHG_FLOAT  fShadow = ( fDepth - vShadowSample.x < 0.1 ) ? 1.0 : 0.0;
#endif
#else
...
#else
		fShadow += ( fDepth - vShadowSample.x < 0.1) ? 0.333 : 0.0;
#endif
	}
#endif	
...
#if !GREYSCALE
	return vDiffuse * vLightDirection.w * fShadow;
#else
	return dot( vDiffuse * vLightDirection.w * fShadow, vGreyScale );
#endif
