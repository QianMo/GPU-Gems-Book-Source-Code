...
public:
    ...
    HRESULT CreateMaterials( LPCTSTR strPath, IDirect3DDevice9 *pd3dDevice, D3DXMATERIAL* d3dxMtrls, DWORD dwNumMaterials );
    HRESULT Destroy();

    CDXUTMesh( LPCTSTR strName = ("CDXUTMeshFile_Mesh") );
    virtual ~CDXUTMesh();
};
...
public:
    ...
    CDXUTMesh*   FindMesh( LPCTSTR strMeshName );
    CDXUTMeshFrame*  FindFrame( LPCTSTR strFrameName );
    ...
    CDXUTMeshFrame( LPCTSTR strName = "CDXUTMeshFile_Frame" );
...
public:
    ...
    CDXUTMeshFile() : CDXUTMeshFrame( "CDXUTMeshFile_Root" ) {}
};
