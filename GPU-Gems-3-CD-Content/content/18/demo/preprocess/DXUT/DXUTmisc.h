...
public:
	...
	TYPE&   GetAt( int nIndex ) {return m_pData[nIndex];} //{ assert( nIndex >= 0 && nIndex < m_nSize ); return m_pData[nIndex]; }
...
{
public:
    CDXUTPerfEventGenerator( D3DCOLOR color, LPCTSTR pstrMessage ) { color; pstrMessage; DXUT_BeginPerfEvent( color, pstrMessage ); }
