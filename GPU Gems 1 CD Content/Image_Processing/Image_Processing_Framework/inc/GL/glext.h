...
extern void APIENTRY glGetVertexAttribdvARB(GLuint index, GLenum pname, double *params);
extern void APIENTRY glGetVertexAttribfvARB(GLuint index, GLenum pname, float *params);
extern void APIENTRY glGetVertexAttribivARB(GLuint index, GLenum pname, GLint *params);
extern void APIENTRY glGetVertexAttribPointervARB(GLuint index, GLenum pname, GLvoid **pointer);
#endif
...
typedef void (APIENTRY * PFNGLGETVERTEXATTRIBDVARBPROC)(GLuint index, GLenum pname, double *params);
typedef void (APIENTRY * PFNGLGETVERTEXATTRIBFVARBPROC)(GLuint index, GLenum pname, float *params);
typedef void (APIENTRY * PFNGLGETVERTEXATTRIBIVARBPROC)(GLuint index, GLenum pname, GLint *params);
